...
/**
 * A TitlePageIndicator is a PageIndicator which displays the title of left view (if exist), the title of the current select view (centered) and the title of the right view (if exist). When the user
 * scrolls the ViewPager then titles are also scrolled.
 */
public class TitlePageIndicator extends View implements PageIndicator {
	/**
	 * Percentage indicating what percentage of the screen width away from center should the underline be fully faded. A value of 0.25 means that halfway between the center of the screen and an edge.
	 */
	private static final float SELECTION_FADE_PERCENTAGE = 0.25f;

	/**
	 * Percentage indicating what percentage of the screen width away from center should the selected text bold turn off. A value of 0.05 means that 10% between the center and an edge.
	 */
